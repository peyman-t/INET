...
#include "REDDropperNUMDual2.h"
#include "opp_utils.h"
#include "IPv4Datagram.h"


Define_Module(REDDropperNUMDual2);

REDDropperNUMDual2::~REDDropperNUMDual2()
{
    delete[] minths;
    delete[] maxths;
    delete[] maxps;
...
void REDDropperNUMDual2::initialize()
{
...
void REDDropperNUMDual2::markECN(cPacket *packet)
{
...
bool REDDropperNUMDual2::isMarkedECN(cPacket *packet)
{
    IPv4Datagram * ipPacket = check_and_cast<IPv4Datagram*>(packet);
...
bool REDDropperNUMDual2::shouldDrop(cPacket *packet)
{
    ...
    if(ct >= SIMTIME_DBL(r_time) + 0.01) {
        ...
        p = p + beta * (avgRate - pkrate / 100 * 0.6);
...
void REDDropperNUMDual2::sendOut(cPacket *packet)
{
