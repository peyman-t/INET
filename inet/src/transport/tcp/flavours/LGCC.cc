...
LGCC::LGCC() : TCPTahoeRenoFamily(),
        state((TCPRenoStateVariables *&)TCPAlgorithm::state)
{
}

void LGCC::recalculateSlowStartThreshold()
{
    // RFC 2581, page 4:
...
void LGCC::processRexmitTimer(TCPEventCode& event)
{
...
void LGCC::processRateUpdateTimer(TCPEventCode& event)
{
...
void LGCC::receivedDataAck(uint32 firstSeqAcked)
{
...
void LGCC::receivedDuplicateAck()
{
