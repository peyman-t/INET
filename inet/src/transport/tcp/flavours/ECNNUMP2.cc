...
Register_Class(ECNNUMP2);


ECNNUMP2::ECNNUMP2() : TCPTahoeRenoFamily(),
        state((TCPRenoStateVariables *&)TCPAlgorithm::state)
{
}

void ECNNUMP2::recalculateSlowStartThreshold()
{
    // RFC 2581, page 4:
...
void ECNNUMP2::processRexmitTimer(TCPEventCode& event)
{
...
void ECNNUMP2::processRateUpdateTimer(TCPEventCode& event)
{
...
void ECNNUMP2::processPaceTimer(TCPEventCode& event)
{
...
void ECNNUMP2::receivedDataAck(uint32 firstSeqAcked)
{
...
void ECNNUMP2::receivedDuplicateAck()
{
