    ...
    switch (fsm.getState())
    {
        case TCP_S_INIT:
            ...
            if (remoteAddr.isUnspecified() || remotePort == -1) {
                if(tcpMain != NULL)
                    ...
                    throw cRuntimeError(tcpMain2, "Error processing command OPEN_ACTIVE: remote address and port must be specified");
            }
            ...
            if (localPort == -1)
            {
                if(tcpMain != NULL)
                    ...
                    localPort = tcpMain2->getEphemeralPort();
            ...
            if(tcpMain != NULL)
                ...
                tcpMain2->addSockPair(this, localAddr, remoteAddr, localPort, remotePort);
        ...
        default:
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Error processing command OPEN_ACTIVE: connection already exists");
    }
    ...
    switch (fsm.getState())
    {
        case TCP_S_INIT:
            ...
            if (localPort == -1) {
                if(tcpMain != NULL)
                    ...
                    throw cRuntimeError(tcpMain2, "Error processing command OPEN_PASSIVE: local port must be specified");
            }
            ...
            if(tcpMain != NULL)
                ...
                tcpMain2->addSockPair(this, localAddr, IPvXAddress(), localPort, -1);
            break;
        ...
        default:
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Error processing command OPEN_PASSIVE: connection already exists");
    }
...
//            break;
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Error processing command SEND: connection not open");
        ...
        case TCP_S_LISTEN:
            ...
            sendQueueSizeVector->record(sendQueue->getBytesAvailable(state->snd_una));
        ...
        case TCP_S_TIME_WAIT:
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Error processing command SEND: connection closing");
    }
    ...
    switch (fsm.getState())
    {
        case TCP_S_INIT:
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Error processing command CLOSE: connection not open");
        ...
        case TCP_S_TIME_WAIT:
            ...
            if(tcpMain != NULL)
                ...
                throw cRuntimeError(tcpMain2, "Duplicate CLOSE command: connection already closing");
    }
}
