...
#define tcpEV1 (ev.isDisabled()||TCP2::testing)?EV:EV

// macro for more verbose EV<< logging (Note: deliberately no parens in macro def)
#define tcpEV21 (ev.isDisabled()||TCP2::testing||!TCP2::logverbose)?EV:EV

// testingEV writes log that automated test cases can check (*.test files)
#define testingEV1 (ev.isDisabled()||!TCP2::testing)?EV:EV
 ...
 */
class INET_API TCP2 : public cSimpleModule, public ILifecycle
{
  public:
