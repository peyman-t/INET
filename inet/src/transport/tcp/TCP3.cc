...
bool TCP3::testing;
bool TCP3::logverbose;

#define EPHEMERAL_PORTRANGE_START 1024
#define EPHEMERAL_PORTRANGE_END   5000

static std::ostream& operator<<(std::ostream& os, const TCP3::SockPair& sp)
{
...
static std::ostream& operator<<(std::ostream& os, const TCP3::AppConnKey& app)
{
...
void TCP3::initialize(int stage)
{
...
void TCP3::handleMessage(cMessage *msg)
{
    if (!isOperational)
    {
...
TCPConnection *TCP3::createConnection(int appGateIndex, int connId)
{
    return new TCPConnection((TCP*)this, appGateIndex, connId);
}

void TCP3::segmentArrivalWhileClosed(TCPSegment *tcpseg, IPvXAddress srcAddr, IPvXAddress destAddr)
{
...
TCPConnection *TCP3::findConnForSegment(TCPSegment *tcpseg, IPvXAddress srcAddr, IPvXAddress destAddr)
{
    SockPair key;
...
TCPConnection *TCP3::findConnForApp(int appGateIndex, int connId)
{
    AppConnKey key;
    key.appGateIndex = appGateIndex;
    key.connId = connId;
...
void TCP3::addSockPair(TCPConnection *conn, IPvXAddress localAddr, IPvXAddress remoteAddr, int localPort, int remotePort)
{
...
void TCP3::updateSockPair(TCPConnection *conn, IPvXAddress localAddr, IPvXAddress remoteAddr, int localPort, int remotePort)
{
...
void TCP3::addForkedConnection(TCPConnection *conn, TCPConnection *newConn, IPvXAddress localAddr, IPvXAddress remoteAddr, int localPort, int remotePort)
{
...
void TCP3::removeConnection(TCPConnection *conn)
{
...
TCPSendQueue* TCP3::createSendQueue(TCPDataTransferMode transferModeP)
{
...
TCPReceiveQueue* TCP3::createReceiveQueue(TCPDataTransferMode transferModeP)
{
    switch (transferModeP)
    {
...
bool TCP3::handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback)
{
    Enter_Method_Silent();
